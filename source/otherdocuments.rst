...
have to send a demo video. The report template you can download from the following `link <../../source/templates/Technical_Report.doc>`_. 
...
you can update the current state in each month. `Here <../../source/templates/ProjectPlan.xlsx>`_ a simple project plan example, where the first sheet presents a time plan and the second sheet can
