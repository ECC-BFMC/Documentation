...
- **Flashing the vehicle** – After saving, the new calibration files must be copied in the Embedded project, then the project must be :doc:`build & flashed <../embeddedplatform/buildAndFlash>`, according to the documentation.